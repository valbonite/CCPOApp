...
if( isset( $_POST["submit"])) {
    ...
    $query = "INSERT INTO master_data ( id, date, day, time, areaofincident, barangay, street, latitude, longitude, crimetype, indexcrimetype, crimecategory, classification ) VALUES ( NULL, '$date', '$day', '$time', '$areaofincident', '$barangay', '$street', '$latitude', '$longitude', '$crimetype', '$indexcrimetype', '$crimecategory', '$classification' )";
...
/*if ($_FILES[csv][size] > 0) { 
    ...
    do { 
        if ($data[0]) { 
            mysql_query("INSERT INTO master_data ( id, date, day, time, areaofincident, barangay, street, latitude, longitude, crimetype, indexcrimetype, crimecategory, classification ) VALUES 
                ( 
                    '".addslashes($data[0])."', 
                    '".addslashes($data[1])."', 
                    '".addslashes($data[2])."', 
...
/*  
  // Insert our data
  $sql = "INSERT INTO master_data ( date, day, time, areaofincident, barangay, street, latitude, longitude, crimetype, indexcrimetype, crimecategory, classification ) VALUES ( '{$connection->real_escape_string($_POST['date'])}', '{$connection->real_escape_string($_POST['day'])}', '{$connection->real_escape_string($_POST['time'])}', '{$connection->real_escape_string($_POST['areaofincident'])}', '{$connection->real_escape_string($_POST['barangay'])}', '{$connection->real_escape_string($_POST['street'])}', '{$connection->real_escape_string($_POST['latitude'])}', '{$connection->real_escape_string($_POST['longitude'])}', '{$connection->real_escape_string($_POST['crimetype'])}', '{$connection->real_escape_string($_POST['indexcrimetype'])}', '{$connection->real_escape_string($_POST['crimecategory'])}', '{$connection->real_escape_string($_POST['classification'])}' )";
...
map.setMapTypeId(customMapTypeId);
      ...
      downloadUrl("phpsqlajax_genxml.php", function(data) {
        ...
        for (var i = 0; i < markers.length; i++) {
          ...
          var marker = createMarker(point, crime, address, type);
   ...
   function createMarker(point, crime, address, type) {
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <div class="filters">
                                        <label class="control-label " for="crimefilter">INDEX CRIME</label>
                                        <input type="checkbox" id="indexCheckbox" onclick="toggleGroup('INDEX CRIME')" />
                                    </div>
                                </li>
                            </ul>                          
                        </li>
